    ...
    return (  
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                <h1 className='text-center fs-2'>We pioneered the discount broking model in India.<br/>Now, we are breaking ground with our technology.</h1>
            </div>
            <hr/>
            <div className='row p-5 mt-5 text-muted' style={{lineHeight: "1.8", fontSize: "1.2em"}}>
                <div className='col-6 p-5'>
                    ...
                    <p>Over 1+ Crore clients place millions of orders every day through our powerfull ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.</p>
                </div>
                <div className='col-6 p-5'>
